...
(function (global) {
  ...
  "Ingresa tu número de empleado y contraseña para continuar.": "Enter your employee number and password to continue.",
  "Contraseña": "Password",
  "Ingresa tu contraseña": "Enter your password",
  "Acceso disponible únicamente para usuarios autorizados.": "Access is available to authorized users only.",
  "Ingresa tu número de empleado y contraseña.": "Enter your employee number and password.",
  "Usuario o contraseña incorrectos.": "Incorrect employee number or password.",
  "El acceso seguro no está disponible en este navegador.": "Secure access is not available in this browser.",
